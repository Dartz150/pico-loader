...
static const u32 sOSResetSystemPatternSdk3Old[] = { 0xE59F1014u, 0xE3A00010u, 0xE5814000u, 0xEB000003u };
...
bool OSResetSystemPatch::FindPatchTarget(PatchContext& patchContext)
{
    ...
    else
    {
        ...
        {
            _osResetSystem = patchContext.FindPattern32(sOSResetSystemPatternSdk3Old, sizeof(sOSResetSystemPatternSdk3Old));
        }
